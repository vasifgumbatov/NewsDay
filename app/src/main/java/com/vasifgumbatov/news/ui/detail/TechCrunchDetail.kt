...
import com.vasifgumbatov.news.databinding.FragmentTechCrunchDetailBinding
import com.vasifgumbatov.news.ui.core.CoreFragment
import dagger.hilt.android.AndroidEntryPoint
import java.util.Locale

@AndroidEntryPoint
class TechCrunchDetail : CoreFragment<FragmentTechCrunchDetailBinding>() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentTechCrunchDetailBinding.inflate(inflater, container, false)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textToSpeech = TextToSpeech(requireContext()) { status ->
            if (status == TextToSpeech.SUCCESS) {
                ...
                // speech speed(0.5f, 1.0f, 2.0f)
                textToSpeech.setSpeechRate(1.0f)

                // tone of voice(0.5f, 1.0f, 2.0f)
                textToSpeech.setPitch(1.0f)
            }
        }

        // Click listener for text-to-speech button
    ...
    private fun setUpNewsDetails(
        binding: FragmentTechCrunchDetailBinding,
        author: String?,
        title: String?,
        imageUrl: String?,
        content: String?,
