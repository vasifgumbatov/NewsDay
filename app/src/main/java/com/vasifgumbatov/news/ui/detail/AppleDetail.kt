...
import com.vasifgumbatov.news.databinding.FragmentAppleDetailBinding
import com.vasifgumbatov.news.ui.core.CoreFragment
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AppleDetail : CoreFragment<FragmentAppleDetailBinding>() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentAppleDetailBinding.inflate(inflater, container, false)
        return binding?.root
    }
    ...
    private fun setUpNewsDetails(
        binding: FragmentAppleDetailBinding,
        author : String?,
        title : String?,
        imageUrl : String?,
        content : String?,
